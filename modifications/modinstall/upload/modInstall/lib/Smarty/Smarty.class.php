 ...
 */
     ...
     * @param string $scope
     */
    function config_load($dir="", $file, $section = null, $scope = 'global')
    {
        if ( $dir="")
        {

            $dir = $smarty->config_dir;

        }

        require_once($this->_get_plugin_filepath('function', 'config_load'));
        smarty_function_config_load(array('overide' => $overide, 'file' => $file, 'section' => $section, 'scope' => $scope), $this);
    }
