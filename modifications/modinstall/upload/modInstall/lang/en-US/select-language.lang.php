<?php
/**
 * modInstall Language Selection Langs
...
/**
 * SELECT-LANGUAGE SET - Values for the language selection step.
 *
 */

$LANG = array(

	"stepTitle" => "Language Selection",
	"stepDesc" => "Please select a language for use with the modInstall UseBB .2 Installation Wizard."
