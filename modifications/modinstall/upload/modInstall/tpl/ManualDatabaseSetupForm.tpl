											...
											<table width="92%" align="center" class="contentcell" height="100%">
												...
												<tr>
													...
													<td valign="top">
														...
														<form name="form" method="post" action="modInstall.php?step=db_manual_create">
															
															<table width="75%" border="0">
																
																<tr>

																	<td>{$lang.dbhost}</td><td><input type="text" name="db_host" value="localhost" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.dbname}</td><td><input type="text" name="db_name" value="" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.dbuser}</td><td><input type="text" name="db_user" value="" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.dbpass}</td><td><input type="password" name="db_pass" value="" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.dbprefix}</td><td><input type="text" name="db_prefix" value="usebb_" disabled="disabled" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.dbtype}</td><td<select name="db_type"><option selected="selected" value="mysql">MySQL</option></select></td>
																</tr>
																<tr>
