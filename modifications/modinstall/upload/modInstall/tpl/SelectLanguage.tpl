 ...
 <html>
	...
	<script language="javascript">
		...
		function process()
		{
			...
			if (document.form.lang.options[document.form.lang.selectedIndex].value != "")
			{
											...
											<table width="92%" align="center" class="contentcell" height="100%">
												...
												<tr>
													...
													<td valign="top">
														...
														<form name="form" method="post" action="modInstall.php?step=lang">
															
															<select name="lang" onChange="process();">
