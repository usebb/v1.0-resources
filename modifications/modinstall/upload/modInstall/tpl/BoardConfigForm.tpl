											...
											<table width="92%" align="center" class="contentcell" height="100%">
												...
												<tr>
													...
													<td valign="top">
														...
														<form name="form" method="post" action="modInstall.php?step=board_config">
															
															<table width="75%" border="0">
																
																<tr>

																	<td>{$lang.board_url}</td><td><input type="text" name="board_url" value="{$requestUrl}" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.board_title}</td><td><input type="text" name="board_title" value="{$lang.my_board}" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.board_desc}</td><td><input type="text" name="board_desc" value="{$lang.my_desc}" size="30" /></td>
																</tr>
																<tr>
																	<td>{$lang.admin_email}</td><td><input type="text" name="admin_email" value="{$lang.adminEmail}" size="30" /></td>
																</tr>
																<tr>
																	<td colspan="2"><input type="submit" value="{$lang.proceed}" /></td>
																</tr>
															</table>
														</form>
