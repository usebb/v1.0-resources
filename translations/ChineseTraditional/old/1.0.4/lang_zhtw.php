...
$lang['Day'] = '日';
$lang['Year'] = '年';
$lang['PoweredBy'] = '%s 該網站程式製作 %s';
$lang['ForumSoftware'] = '討論區軟體';
...
$lang['Sort'] = '排列';
$lang['SortBy'] = '排列於';
$lang['SortBy-displayed_name'] = '會員名稱';
$lang['SortBy-real_name'] = '真實姓名';
$lang['SortBy-level'] = '會員等級';
$lang['SortBy-rank'] = '等級';
$lang['SortBy-regdate'] = '已註冊';
$lang['SortBy-posts'] = '發表數';
$lang['SortBy-latest_post'] = '最新發表';
$lang['SortBy-topic_title'] = '主題標題';
$lang['SortBy-forum'] = '討論區';
$lang['SortBy-author'] = '作者';
$lang['SortBy-replies'] = '回覆';
$lang['SortBy-views'] = '瀏覽';
$lang['SortOrder-asc'] = '向上排列';
$lang['SortOrder-desc'] = '向下排列';
$lang['NoUsersFound'] = '沒有找到該會員.';
$lang['SaveConfigManually'] = '因為 config.php 無法寫入, UseBB 無法儲存該設定值. 請將下列的內容寫入 config.php 並上傳.';
$lang['ShowResultsAs'] = '顯示結果';
$lang['ShowMode-topics'] = '主題';
$lang['ShowMode-posts'] = '發表';
$lang['Mode-and'] = '全部關鍵字(AND)';
$lang['Mode-or'] = '任何關鍵字 (OR)';
$lang['ExactMatch'] = '精準搜尋';
$lang['IncludeGuests'] = '包含訪客';
$lang['Top'] = '上面';
$lang['Bottom'] = '底部';
$lang['Action'] = '動作';
?>
