...
$faq[] = array('註冊時需要甚麼資訊?', '註冊時, 您需要輸入帳號 (登入名稱) . 您也可以輸入真實姓名於於帳號中. 註冊您無法便跟您的帳號, 但您可以變更顯示名稱. 接下來您需要電子信箱 (特別是需要啟動您的帳號時) 並選擇您的密碼(您可以變更密碼).');
...
$faq[] = array('帳號，顯示名稱跟真實姓名有甚麼差別?', '帳號是您登入論壇的的名稱,您無法變更它。但顯示名稱 (預設為跟帳號相同) 為您實際顯示於版面時的名稱，您可以不斷的變更。您的真實姓名不是非必要性的顯示於您的個人資訊上.');
