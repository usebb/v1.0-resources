...
/*
	...
	$Header: /cvsroot/usebb/UseBB/languages/lang_English.php,v 1.125 2006/08/12 17:44:26 pc_freak Exp $
...
$lang['Topics'] = 'Sujets';
$lang['Posts'] = 'Billets';
$lang['LatestPost'] = 'Dernier billet';
$lang['RSSFeed'] = 'Flux RSS';
$lang['NewPosts'] = 'Nouveaux billets';
$lang['NoNewPosts'] = 'Pas de nouveaux billets';
$lang['LockedNewPosts'] = 'Bloqu&eacute; (nouveaux billets)';
$lang['LockedNoNewPosts'] = 'Bloqu&eacute; (pas de nouveaux billets)';
$lang['Locked'] = 'Bloqu&eacute;';
$lang['LastLogin'] = 'Derni&egrave;re connection';
$lang['VariousInfo'] = 'Informations diverses';
$lang['IndexStats'] = 'Ce forum contient %d billet(s) dans %d sujet(s) et a %d membre(s) enregistr&eacute;(s).';
...
'Vous acceptez le fait que tous les billets présents dans ce forum reflètent les opinions de leurs auteurs respectifs et non pas du webmaster, des modérateurs ou des administrateurs du forum, sauf quand ces derniers écrivent eux-mêmes des billets.

Vous vous engagez à ne placer sur ce forum que des billets dont le contenu n\'est pas blessant, offensant, obscène ou inaproprié, et qui n\'est pas interdit par la loi. Si vous agissez de la sorte, vous serez pénalisé car votre compte recevra immédiatement le statut \'banni\' ou \'supprimé\' et votre fournisseur d\'accès internet pourra éventuellement être averti de votre comportement. De plus, votre adresse IP est enregistrée avec chaque billet que vous placez. Vous acceptez aussi le fait que les administrateurs et modérateurs sont autorisés à éditer, supprimer, déplacer ou fermer vos sujets quand ils pensent que c\'est nécessaire.
...
$lang['NoSuchPost'] = 'Le billet %s n\'existe pas/plus dans ce forum.';
...
$lang['DeletePost'] = 'Supprimer le billet';
$lang['ConfirmDeletePost'] = 'Etes-vous s&ucirc;r de vouloir supprimer ce billet dans le forum %s ? Ceci est irr&eacute;versible !';
$lang['EditPost'] = 'Editer le billet';
...
$lang['EditingPost'] = 'Modification de billet dans %s';
$lang['DeletingPost'] = 'Suppression de billet dans %s';
...
$lang['ViewMorePosts'] = 'Voir plus de billets';
...
$lang['PostsPerMember'] = 'Billets par membre';
$lang['PostsPerForum'] = 'Billets par forum';
...
$lang['SearchMembersPosts'] = 'Rechercher les billets de ce membre';
...
$lang['SortBy-posts'] = 'Billets';
$lang['SortBy-latest_post'] = 'Dernier billet';
