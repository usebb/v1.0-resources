...
/*
	...
	$Header: /cvsroot/usebb/UseBB/languages/faq_French.php,v 1.9 2006/09/17 21:17:52 pc_freak Exp $
...
$faq[] = array('Qui sont les mod&eacute;rateurs et les administrateurs ?',
               'Un mod&eacute;rateur est un membre particulier qui v&eacute;rifie et surveille une ou plusieurs parties du forum, pour rep&eacute;rer les billets douteux. Il/elle peut aussi venir en aide aux utilisateurs de son forum. Un administrateur est un mod&eacute;rateur de l\'int&eacute;gralit&eacute; du forum, qui peut d&eacute;signer de nouveaux mod&eacute;rateurs et qui a le pouvoir de changer toutes les options disponibles pour la configuration de son forum.');
...
$faq[] = array('--',
               'Sujets et billets');
$faq[] = array('Que sont les sujets et les billets ?',
               'Un sujet est un groupe de messages ( = les billets) dans une partie du forum. Si vous cliquez sur le nom d\'une partie du forum, vous pourrez voir une liste de tous les sujets qu\'elle contient.');
...
$faq[] = array('Pourquoi ne puis-je pas placer de nouveaux sujets ou des r&eacute;ponses ?',
               'Si aucun lien n\'est visible pour vous permettre de cr&eacute;er un nouveau sujet ou pour placer un nouveau billet ( = une r&eacute;ponse), c\'est parce que vous n\'&ecirc;tes pas autoris&eacute; &agrave; le faire sur ce forum. Cela peut &ecirc;tre d&ucirc; &agrave; une volont&eacute; d\'un mod&eacute;rateur qui a d&eacute;cid&eacute; de fermer cette partie du forum ou ce sujet en particulier. Dans le doute, contactez l\'administrateur.');
$faq[] = array('Qu\'est-ce que le BBCode et les smileys ?',
               'Le BBCode est un ensemble de balises (comme en langage HTML) que vous pouvez utiliser pour ajouter certains &eacute;l&eacute;ments (images, couleurs, citations,...) dans vos billets. Essayez-en quelques uns, et faites un aper&ccedil;u de vos billets pour voir ce qu\'ils permettent de faire. Les smileys sont de petites t&ecirc;tes jaunes qui vous permettent d\'exprimer vos &eacute;motions dans vos billets.');
$faq[] = array('Mon compteur de billets n\'augmente pas quand j\'en place un ?',
               'Dans certains forums, l\'incr&eacute;mentation du comptage de vos billets est d&eacute;sactiv&eacute;e. C\'est souvent le cas pour des tests ou dans des forums de chat intensif.');
$faq[] = array('Pourquoi dois-je attendre un certain temps entre deux &eacute;critures ?',
               'C\'est une protection contre le flood ( = submerger le serveur avec des envois de billets en masse). Le but est aussi d\'&eacute;viter le spamming. Veuillez donc attendre un petit peu avant d\'envoyer votre billet suivant.');
