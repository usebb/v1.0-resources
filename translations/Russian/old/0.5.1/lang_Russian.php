...
$lang['IndexStats'] = 'В этих форумах содержится %d сообщений в %d темах созданных %d пользователями.';
...
$lang['AutoLoginSet'] = 'Кука автовхода установлена.';
$lang['AutoLoginUnset'] = 'Кука автовхода удалена.';
...
$lang['FeatureDisabledBecauseCookiesDisabled'] = 'Эта возможность отключена, так как форум не может установить или прочитать куку из вашего браузера.';
$lang['LogOutConfirm'] = 'Вы действительно хотите выйти? Все куки автовхода будут удалены!';
$lang['Cancel'] = 'Отмена';
...
$lang['TopicReview'] = 'Содержимое темы';
